...
<body>
<div id="no-webgl">
    Stuff in Space requires <a href="http://caniuse.com/#feat=webgl">WebGL</a> and <a
            href="http://caniuse.com/#feat=webworkers">Web Worker</a> support.
</div>
    ...
    <div id="menu-right" class="menubar">
        <div id="menu-help" class="menu-item">
            ...
            <div id="help-box" class="menubox submenu">
                ...
                <ul id="legend">
                    <li>
                        <img class="dot" src="/dot-green.png"></img>
                        Satellite
                    </li>
                    <li>
        ...
        <div id="menu-about" class="menu-item">
            ...
            <div id="about-box" class="menubox submenu">
                ...
                <p>The website updates daily with orbit data from <a
                            href="http://www.space-track.org">Space-Track.org</a>
                    and uses the excellent <a href="https://github.com/shashwatak/satellite-js">satellite.js</a>
                    Javascript library
